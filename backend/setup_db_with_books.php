...
try {
    echo "Setting up database with real book data...\n";
    ...
    try {
        $pdo->exec("ALTER TABLE categories ADD COLUMN color VARCHAR(7) DEFAULT '#3498db'");
    ...
    // Insert authors
    $pdo->exec("
        INSERT IGNORE INTO authors (id, first_name, last_name, biography, nationality) VALUES
    ...
    // Insert books
    $pdo->exec("
        INSERT IGNORE INTO books (id, isbn, title, description, publication_date, publisher, pages, category_id, total_copies, available_copies, rating, total_ratings, cover_image) VALUES
        ...
        (4, '978-0-13-208670-1', 'Clean Code', 'A handbook of agile software craftsmanship for writing maintainable code.', '2008-08-01', 'Prentice Hall', 464, 3, 8, 5, 4.6, 120, null),
        (5, '978-0-262-03384-8', 'Introduction to Algorithms', 'Comprehensive guide to algorithms and data structures.', '2009-07-31', 'MIT Press', 1312, 3, 3, 1, 4.8, 89, null),
    ...
    echo "Added 6 categories, 8 authors, and 8 books.\n";
